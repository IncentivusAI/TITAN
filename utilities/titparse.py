...
def check_args_torchrun_main(args):
    ...
    if args.save_dir is None:
        # create checkpoints / model name with timestamp
    ...
    if args.dtype in ["fp16", "float16"]:
        raise NotImplementedError("fp16 not supported in torchrun_main.py. Use deepspeed_main.py instead (though it may have issues).")
